...
{:else}
    <div class="align autoFontSize" style="{style}{item && 'alignX' in item && item.alignX ? '' : (item?.align || 'justify-content: center;').replaceAll('text-align', 'justify-content')}" on:dblclick={openInDrawer}>

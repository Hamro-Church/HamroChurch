...
export const nepaliTypingEnabled: Writable<boolean> = writable(false)
...
export const obsData: Writable<{ connected?: boolean; ip?: string; port?: number; password?: string }> = writable({}) // {}
